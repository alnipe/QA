...
SELECT TOP 3 CustomerName, City, Country FROM Customers;
...
SELECT * FROM Customers
WHERE City NOT LIKE 'a%' AND NOT Country = 'Germany';
...
SELECT * FROM Customers
WHERE City IN ('Bern','Berlin','London') AND CustomerID BETWEEN 10 AND 30;
